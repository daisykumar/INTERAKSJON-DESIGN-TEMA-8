    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "todo-item svelte-1nnluyk");
    			add_location(div, file$1, 114, 12, 3184);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1nnluyk");
    			add_location(h1, file$1, 99, 8, 2618);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "todo-input svelte-1nnluyk");
    			attr_dev(input0, "placeholder", "click a to-do, select target date, and hit enter...");
    			add_location(input0, file$1, 100, 8, 2645);
    			attr_dev(div0, "class", "date svelte-1nnluyk");
    			add_location(div0, file$1, 103, 12, 2839);
    			attr_dev(button0, "class", "enterButton svelte-1nnluyk");
    			add_location(button0, file$1, 110, 8, 3050);
    			attr_dev(div1, "class", "wrapper");
    			add_location(div1, file$1, 102, 8, 2805);
    			attr_dev(input1, "class", "inner-container-input svelte-1nnluyk");
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$1, 119, 24, 3419);
    			add_location(label, file$1, 119, 17, 3412);
    			add_location(div2, file$1, 119, 12, 3407);
    			attr_dev(div3, "class", "leftItems svelte-1nnluyk");
    			add_location(div3, file$1, 120, 12, 3534);
    			attr_dev(div4, "class", "inner-container svelte-1nnluyk");
    			add_location(div4, file$1, 118, 8, 3365);
    			add_location(strong, file$1, 124, 102, 3764);
    			attr_dev(button1, "class", "svelte-1nnluyk");
    			toggle_class(button1, "active", /*currentFilter*/ ctx[1] === "all");
    			add_location(button1, file$1, 124, 16, 3678);
    			attr_dev(button2, "class", "svelte-1nnluyk");
    			toggle_class(button2, "active", /*currentFilter*/ ctx[1] === "active");
    			add_location(button2, file$1, 125, 16, 3810);
    			attr_dev(button3, "class", "svelte-1nnluyk");
    			toggle_class(button3, "completed", /*currentFilter*/ ctx[1] === "completed");
    			add_location(button3, file$1, 126, 16, 3934);
    			add_location(div5, file$1, 123, 12, 3656);
    			attr_dev(button4, "class", "svelte-1nnluyk");
    			add_location(button4, file$1, 129, 16, 4107);
    			add_location(div6, file$1, 128, 12, 4085);
    			attr_dev(div7, "class", "inner-container svelte-1nnluyk");
    			add_location(div7, file$1, 122, 8, 3614);
    			attr_dev(div8, "class", "container svelte-1nnluyk");
    			add_location(div8, file$1, 98, 4, 2586);
    			add_location(main, file$1, 97, 0, 2575);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
